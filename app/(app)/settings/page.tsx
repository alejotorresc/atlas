...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        <h2 className="mb-2 text-sm font-medium text-[var(--ds-neutral-500)]">Perfil</h2>
        <Card>
      ...
      <section>
        <h2 className="mb-2 text-sm font-medium text-[var(--ds-neutral-500)]">Categorias</h2>
        <CategoryManager categories={categories} />
      </section>

      <section>
        <h2 className="mb-2 text-sm font-medium text-[var(--ds-neutral-500)]">Preferencias financieras</h2>
        <Card>
      ...
      <section>
        <h2 className="mb-2 text-sm font-medium text-[var(--ds-neutral-500)]">Datos</h2>
        <Card className="space-y-3">
          <div>
            <p className="text-sm font-medium">Exportar movimientos</p>
            <p className="text-sm text-[var(--ds-neutral-600)]">Descarga todos tus movimientos en formato CSV.</p>
            <a href="/api/export" className="mt-2 inline-block rounded-md bg-[var(--ds-color-primary)] px-4 py-2 text-sm font-medium text-white">
              Exportar CSV
            </a>
          </div>
          <div className="border-t border-[var(--ds-neutral-100)] pt-3">
